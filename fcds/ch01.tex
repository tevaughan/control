      ...
      \item For the manual steering system, see
         ...
         \begin{itemize}
            ...
            \item This imagined reference image is compared with the observed
               ...
               mind, which serves as comparator, compares the imagined
               reference image with the observed image and derives an angular
               steering error, which might be measured in degrees, but the
               error signal might be a neural state.
         \end{itemize}
